...
public class VehicleRecord {
  ...
  public String formatReadable(LocalDateTime time) {
    return time != null ? time.format(DateTimeFormatter.ofPattern("HH:mm:ss dd-MM-yyyy")) : "N/A";
  }

  @Override
  public String toString() {
    return carVRN + "," + formatReadable(entryTime) + "," + formatReadable(exitTime);
  }
}
